...
public class SupplierFood extends Supplier {

    public SupplierFood(String nameSupplier, String numberContract, int phoneNumber, String addressSupplier, String emailAddress, String bankAccount, int unp) {
