...
public class SupplierChemical extends Supplier {
    public SupplierChemical(String nameSupplier, String numberContract, int phoneNumber, String addressSupplier, String emailAddress, String bankAccount, int unp) {
        super(nameSupplier, numberContract, phoneNumber, addressSupplier, emailAddress, bankAccount, unp);
    }

    public SupplierChemical() {
        super();
    }
