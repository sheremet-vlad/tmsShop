...
public class SupplierCloses extends Supplier {
    public SupplierCloses(String nameSupplier, String numberContract, int phoneNumber, String addressSupplier, String emailAddress, String bankAccount, int unp) {


    }

    public SupplierCloses() {
        super();
    }
